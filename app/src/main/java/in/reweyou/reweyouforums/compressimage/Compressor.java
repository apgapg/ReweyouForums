...
public class Compressor {
    ...
    public File compressToFile(Uri uri) {
        return ImageUtil.compressImage(context, uri, maxWidth, maxHeight,
                compressFormat, bitmapConfig, quality, destinationDirectoryPath,
                fileNamePrefix, fileName);
    }

    public Bitmap compressToBitmap(Uri uri) {
        return ImageUtil.getScaledBitmap(context, uri, maxWidth, maxHeight, bitmapConfig);
    }
