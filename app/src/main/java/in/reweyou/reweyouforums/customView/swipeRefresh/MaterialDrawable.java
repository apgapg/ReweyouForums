...
package in.reweyou.reweyouforums.customView.swipeRefresh;
...
//    }
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int x = in.reweyou.reweyouforums.customView.swipeRefresh.MaterialDrawable.this.getBounds().centerX();
            final int y = in.reweyou.reweyouforums.customView.swipeRefresh.MaterialDrawable.this.getBounds().centerY();
