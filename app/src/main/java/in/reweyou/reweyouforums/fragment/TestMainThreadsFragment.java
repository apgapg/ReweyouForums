...
import in.reweyou.reweyouforums.adapter.FeeedsTestAdapter;
...
public class TestMainThreadsFragment extends Fragment {


    private static final String TAG = TestMainThreadsFragment.class.getName();
    private Activity mContext;
    private RecyclerView recyclerView;
    private FeeedsTestAdapter feeedsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View layout = inflater.inflate(R.layout.fragment_main_test_threads, container, false);
        ...
        feeedsAdapter = new FeeedsTestAdapter(mContext, this);
    ...
    private void parsejsonresponse() {
        try {
            ...
            for (int i = 0; i < jsonresponse.length(); i++) {
                ...
                if (groupModel.getType().equals("image1"))
