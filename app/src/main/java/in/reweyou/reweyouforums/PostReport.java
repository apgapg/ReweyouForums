...
import in.reweyou.reweyouforums.classes.AppLocationService;
import in.reweyou.reweyouforums.classes.ConnectionDetector;
import in.reweyou.reweyouforums.classes.MyLocation;
import in.reweyou.reweyouforums.classes.UploadOptions;
import in.reweyou.reweyouforums.classes.UserSessionManager;
import in.reweyou.reweyouforums.customView.CustomSigninDialog;
import in.reweyou.reweyouforums.model.TagsModel;
import in.reweyou.reweyouforums.utils.Constants;

import static in.reweyou.reweyouforums.utils.Constants.POST_REPORT_KEY_ADDRESS;
import static in.reweyou.reweyouforums.utils.Constants.POST_REPORT_KEY_CATEGORY;
import static in.reweyou.reweyouforums.utils.Constants.POST_REPORT_KEY_DESCRIPTION;
import static in.reweyou.reweyouforums.utils.Constants.POST_REPORT_KEY_HEADLINE;
import static in.reweyou.reweyouforums.utils.Constants.POST_REPORT_KEY_IMAGE;
import static in.reweyou.reweyouforums.utils.Constants.POST_REPORT_KEY_LOCATION;
import static in.reweyou.reweyouforums.utils.Constants.POST_REPORT_KEY_NAME;
import static in.reweyou.reweyouforums.utils.Constants.POST_REPORT_KEY_NUMBER;
import static in.reweyou.reweyouforums.utils.Constants.POST_REPORT_KEY_PRIVACY;
import static in.reweyou.reweyouforums.utils.Constants.POST_REPORT_KEY_REPORT;
import static in.reweyou.reweyouforums.utils.Constants.POST_REPORT_KEY_TAG;
    ...
    private void keyboardListener() {
        findViewById(R.id.main_content).getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                if (heightDiff > pxFromDp(PostReport.this, 150)) { // if more than 100 pixels, its probably a keyboard...
